...
EXEMPLOS = [
    {
        ...
        'melhor_epoca': 'Junho a setembro', 'preco_base': 3290, 'diaria': 560,
    ...
    },
    {
        ...
        'melhor_epoca': 'Abril a outubro', 'preco_base': 2490, 'diaria': 480,
    ...
    },
    {
        ...
        'melhor_epoca': 'Abril a setembro', 'preco_base': 3190, 'diaria': 540,
    ...
    def handle(self, *args, **opcoes):
        ...
        for ex in EXEMPLOS:
            ...
            destino = Destino.objects.create(
                ...
                preco_base=ex['preco_base'], preco_medio_diaria=ex['diaria'], destaque=True,
            )
